const Posts = [
  { 
    ...
    body: [
      ...
      { 
        type: "details",
        thumbnail: require("../assets/Types.jpg"),
        ...
        body: [
          ...
          {
            type: "img",
            content: require("../assets/Thrombosis.jpg"),
          },
          {
            type: "p",
      ...
      {
        thumbnail: require("../assets/LeftBrain.jpg"),
        title: "About the Brain",
        subtitle: "Left Brain Functions",
        body: [
      {
            type: "p",
      ...
      {
        thumbnail: require("../assets/RightBrain.jpg"),
        title: "About the Brain",
        subtitle: "Right Brain Functions",
        body: [
          // {
          //   type: "img",
          //   content: require("../assets/RightBrain.jpg"),
          // },
          {
            type: "p",
...
// identifying a stroke
  {
    ...
    body: [
      ...
      {
        type: "h1",
        content: "Sensation-related Symptoms"
      },
      {
        type: "img",
        content: require("../assets/stroke.jpg"),
      ...
      {
        type: "h1",
        content: "Vision-related Symptoms"
      },
      {
        type: "img",
        content: require("../assets/stroke.jpg"),
      ...
      {
        type: "h1",
        content: "Communication-related Symptoms"
      },
      {
        type: "img",
        content: require("../assets/stroke.jpg"),
      ...
      {
        type: "h1",
        content: "Swallowing-related Symptoms"
      },
      {
        type: "img",
        content: require("../assets/stroke.jpg"),
...
// Managing the Risk
  ...
  body: [
    ...
    {
      type: "p",
      content: "Uncontrolled hypertension increases risk of stroke by four times."
    },
    {
      type: "h1",
      content: "Smoking:"
...
// The Hospital Journey
  ...
  body: [
    ...
    {
      type: "h1",
      content: "Heart tests: Echocardiogram"
    },
    {
      type: "img",
      content: require("../assets/stroke.jpg"),
    ...
    {
      type: "p",
      content: "Ultrasound test that checks for the presence of clots"
    },
    {
      type: "p",
      content: "Checks for abnormal communications between the chambers of the heart."
    },
    {
      type: "h1",
      content: "Heart tests: Holter"
    },
    {
      type: "img",
      content: require("../assets/stroke.jpg"),
    ...
    {
      type: "p",
      content: "Checks for any heart rhythm problems over 1 or 2 days."
    },
    {
      type: "h1",
      content: "Heart tests: Electrocardiogram (ECG)"
    },
    {
      type: "img",
      content: require("../assets/stroke.jpg"),
    ...
    {
      type: "p",
      content: "Checks for any abnormal heart rhythm."
    },
    {
      type: "h1",
      content: "Blood tests"
...
{
  thumbnail: require("../assets/stroke.jpg"),
  title: "Post Stroke Guidelines",
  subtitle: "Medical Resources to read when recovering from a Stroke",
  body: [
    {
      type: "h1",
